...
dofile(minions.modpath .. "/core/brain_chat.lua")
dofile(minions.modpath .. "/core/brain_idle.lua")
dofile(minions.modpath .. "/core/brain_moving.lua")
dofile(minions.modpath .. "/core/brain_moving_fail.lua")
dofile(minions.modpath .. "/core/brain_vision.lua")
